...
// TD-19 测试隔离：RecruiterTerminal onMounted 会发起 AI 会话请求（initSession → fetch），
// 本文件仅测首页渲染，不关心招募官终端交互（其行为由 tests/components/ai/RecruiterTerminal.test.js 覆盖）
vi.mock('@/components/ai/RecruiterTerminal.vue', () => ({
  default: {
    name: 'RecruiterTerminal',
    template: '<div class="mock-recruiter-terminal" />',
    props: ['isOpen'],
  },
}))
