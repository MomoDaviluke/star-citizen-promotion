<!--
/**
 * @file MFDPanel 多功能显示屏面板组件
 * @description 模拟星际公民飞船内的多功能显示屏风格，支持 primary/secondary/alert 变体
 * @module components/ui/MFDPanel
 */
-->
<template>
  <!--
...
/* 入场动画 */
.mfd-panel--animated {
  animation: panel-slide-up var(--duration-slow) ease-out;
}
