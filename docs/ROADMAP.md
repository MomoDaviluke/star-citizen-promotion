...
> ⚠️ **已归档（2026-08-30）**：本文件停留在 v1.6.2 视角（「当前步骤 TD-14/15/19」等描述均已过时），仅供历史参考。**现行路线图见 [TECH_ROADMAP_2026-08-30.md](TECH_ROADMAP_2026-08-30.md)**（M0~M7 模块矩阵 + G1~G4 决策门 + 风险矩阵）。
